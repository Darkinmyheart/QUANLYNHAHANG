...
//stcyjlqenokdyyhe
    ...
    public void dangNhapHeThong() {
        ...
        if (username.equals("")) {
            ...
            NhanVien nv = nhanVienDao.dangNhap(username, password, "binh thuong");
            if (nv != null) {
                if (ChkLuuMk.isSelected()) {
                    JOptionPane.showMessageDialog(this, "Mật khẩu đã được lưu vào cơ sở dữ liệu.");
                }
                ServerController.Server.testGui.setnv(nv);
                ArrayList<NguyenLieu> arrnl = new NguyenLieuDao().checkSoLuongNguyenLieu();
                if (arrnl.size() != 0) {
                    String x = "";
                    for (NguyenLieu nguyenLieu : arrnl) {
                        x = x + nguyenLieu.getTen()+": "+nguyenLieu.getSoluong()+"\n";
                    }
                    JOptionPane.showMessageDialog(this, "Các nguyên liệu sắp hết : \n" + x);
                }
                ServerController.Server.testGui.setVisible(true);
                this.dispose();
            } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, "Đang trong quá trình thử nghiệm", "Thông Báo", HEIGHT);
