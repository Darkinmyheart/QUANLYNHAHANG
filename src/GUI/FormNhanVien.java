...
public class FormNhanVien extends javax.swing.JPanel {
    ...
    public void LoadData() {
        ...
        for (int i = 0; i < ds.size(); i++) {
            model.addRow(new Object[]{
                ...
                ds.get(i).getGioitinh(),
                ds.get(i).getDiachi(),
                ds.get(i).getSdt(),
                ds.get(i).getEmail(),
                ds.get(i).getChucVu(),
                SetStringFormat.ConvertBigDecimalToStringFormat(ds.get(i).getLuong()),
                ds.get(i).getNgayTao(),
    ...
    private void initComponents() {
        ...
        txtTongNV.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        txtTongNV.setForeground(new java.awt.Color(204, 0, 0));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, 0)
                        .addComponent(txtTimNv, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel1)
                        .addGap(79, 79, 79)
                        .addComponent(jLabel12)
                        .addGap(27, 27, 27)
                        .addComponent(txtTongNV, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(25, 25, 25))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(txtTongNV, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (a != -1) {
            ...
            String Email = tblNhanVien.getValueAt(i, 6).toString();
            String Chucvu = tblNhanVien.getValueAt(i, 7).toString();
            String Luong = String.valueOf(Utils.SetStringFormat.ConvertStringtoBigDecimal(tblNhanVien.getValueAt(i, 8).toString()));
    ...
    private void txtTimNvKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimNvKeyReleased
        String searchText = txtTimNv.getText().trim();
        ArrayList<NhanVien> tim = new NhanVienDao().GetArrayListByTenNV(searchText);
        model.setRowCount(0);
        for (NhanVien nv : tim) {
            model.addRow(new Object[]{
                nv.getID(),
                ...
                nv.getEmail(),
                nv.getChucVu(),
                SetStringFormat.ConvertBigDecimalToStringFormat(nv.getLuong()),
                nv.getNgayTao(),
                nv.getNgayKetThuc()
            });
        }
